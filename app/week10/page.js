	...
	return (
		...
		<div className="flex flex-row justify-between w-full">
			...
			<div className=" bg-indigo-600 rounded-lg p-6 mr-4">
				...
				<Login />
				{user ? (<div><p className="text-white">Welcome, {user?.displayName}!</p><p><Link href="week10/shopping-list">Your shopping list</Link></p></div>) : (<p className="text-white">Please sign in.</p>)}
			</div>
		</div>
        <div>
            <Link href="./">Back</Link>
